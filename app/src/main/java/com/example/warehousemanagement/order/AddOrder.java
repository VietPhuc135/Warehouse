...
public class AddOrder extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ownerId = DangNhap.account.getUser().getId();

        etName = findViewById(R.id.etOwnerIde);
        etCode = findViewById(R.id.etLineItemse);
        etDate = findViewById(R.id.tvStatuse);
        etStock = findViewById(R.id.tvMessageE);
        etNote = findViewById(R.id.tvStorageIdE);
        etProducer = findViewById(R.id.tvFlagE);
    ...
    private class MyAsyncTask extends AsyncTask<String, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            if (result) {
                System.out.println(jsonObject);
                Intent intent = new Intent(AddOrder.this, DsSanPham.class);
                startActivity(intent);
            } else {
